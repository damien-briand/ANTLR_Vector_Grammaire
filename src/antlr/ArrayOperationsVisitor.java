...
public interface ArrayOperationsVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by the {@code varininstruction}
	 * labeled alternative in {@link ArrayOperationsParser#instruction}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitVarininstruction(ArrayOperationsParser.VarininstructionContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by the {@code initvarvar}
	 * labeled alternative in {@link ArrayOperationsParser#vardecl}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitInitvarvar(ArrayOperationsParser.InitvarvarContext ctx);
	/**
	 * Visit a parse tree produced by the {@code initvararrayvar}
	 * labeled alternative in {@link ArrayOperationsParser#vardecl}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitInitvararrayvar(ArrayOperationsParser.InitvararrayvarContext ctx);
	/**
	 * Visit a parse tree produced by the {@code initvarop}
	 * labeled alternative in {@link ArrayOperationsParser#vardecl}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitInitvarop(ArrayOperationsParser.InitvaropContext ctx);
	/**
	 * Visit a parse tree produced by the {@code initvararrayop}
	 * labeled alternative in {@link ArrayOperationsParser#vardecl}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitInitvararrayop(ArrayOperationsParser.InitvararrayopContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by the {@code affectvar}
	 * labeled alternative in {@link ArrayOperationsParser#affectation}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitAffectvar(ArrayOperationsParser.AffectvarContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link ArrayOperationsParser#varin}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitVarin(ArrayOperationsParser.VarinContext ctx);
	/**
